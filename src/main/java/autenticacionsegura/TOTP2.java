...
public class TOTP2 {
	...
	/**
	 * Genera una clave secreta en el formato base32 (A-Z2-7)
	 */
	
	
	public String generarTokensBase32() {
	 ...
	 */
	public String generarCodigoTOTP(String secret) throws GeneralSecurityException {
		return generateCurrentNumber(secret, System.currentTimeMillis());
	}

	/**
	 * Same as {@link #generarCodigoTOTP(String)} except at a particular time in millis. Mostly for testing
	 * purposes.
	 */
